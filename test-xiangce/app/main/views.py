...
from ..models import User, Album, Photo, Message, LikePhoto, Role, Comment, LikeAlbum
...
def albums(username):
    ...
    pagination = user.albums.order_by(Album.timestamp.desc()).paginate(page, per_page=current_app.config['FANXIANGCE_ALBUMS_PER_PAGE'], error_out=False)
...
def edit_profile_admin(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('.albums', username=user.username))
